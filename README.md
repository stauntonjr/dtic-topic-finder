...
### supply your document as a string
...
### input the string to the dtic callable 
  dtic(your_text)
### output is a dictionary of DTIC topics and terms
...
### topics are of the form "subject; category; subcategory"
